...
//マクロ定義
//---------------------------------------------------
#define TITLE_LOGO_WIDTH		(138 * 5)//画像横幅
#define TITLE_LOGO_HEIGHT		(80 * 5)//画像縦高さ
#define TITLE_LOGO_WIDTH_PATTERN	(1)//横アニメパターン数
#define TITLE_LOGO_HEIGHT_PATTERN	(1)//縦アニメパターン数
