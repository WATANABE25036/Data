...
void DrawSpriteLeftTopCamera(int texNo, float X, float Y, float Width, float Height, float U, float V, float UW, float VH, float r = 1.0f, float g = 1.0f, float b = 1.0f, float a = 1.0f);
