...
#define BUTTON_UPX		0x00004000l	// 十字上ボタン(.rgbButtons[10]0)
#define BUTTON_DOWNX	0x00008000l	// 十字下ボタン(.rgbButtons[11]18000)
#define BUTTON_LEFTX	0x00010000l	// 十字左ボタン(.rgbButtons[12]27000)
#define BUTTON_RIGHTPX	0x00020000l	// 十字右ボタン(.rgbButtons[13]9000)
